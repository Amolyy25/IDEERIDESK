// Google's official unaltered "G" mark — their brand guidelines require it
// on sign-in buttons, so this is the one deliberate exception to the
// yellow-only accent rule (it's Google's mark, not ours).
