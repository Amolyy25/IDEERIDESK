...
import { renderTicketReplyEmailHtml, renderTicketReplyEmailText } from "@/lib/email-template";
...
export async function sendTicketReplyEmail({
  ...
  const html = renderTicketReplyEmailHtml({ ticketNumber: ticket.number, senderName, bodyText });
  const text = renderTicketReplyEmailText({ ticketNumber: ticket.number, senderName, bodyText });
